...
class actorDatatables extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\actor $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(actor $model)
    {
        return $model->query();
    }
    ...
    {
        return $this->builder()
                    ->setTableId('actordatatables-table')
    ...
    {
        return 'actorDatatables_' . date('YmdHis');
    }
}
